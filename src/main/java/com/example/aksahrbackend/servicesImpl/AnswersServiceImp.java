    ...
    public GenericResponse<List<AnswersModel>> getAnswers(AnswersModel answer) throws SQLException {
        ...
        Connection con = connetion.getConnection();
            if (!con.isClosed()) {
                ...
                Date CREATED_DATER = rs.getDate("CREATED_DATE");
                    AnswersModel answerModel = new AnswersModel(CNIC,APPLICANT_NAME, QUALIFICATION, INTERVIEW_POST,INTERVIEWED_BY, CONTACT_NO, EXPERIENCE, QUESTIONS, ANSWERS, null , null ,answer.APPLICANT_ID, null, CREATED_DATE ,null,  null,  null,CREATED_DATER);
